...
Data visualization generated by `datarepgen.py`:
...
* 3D __map__: grouped bar chart on map as in [samples/geo/settings.json](samples/geo/settings.json) generated by `georepgen.py`
...
* __Auto-Placing__ of 3D chart using _Spatial Reasoning_: 
